...
function pars_value()
{
	...
	h = h + dh;
	text = "Del.ang.gd. 4 (gd. 44, 52, 108, 116)";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	...
	h = h + dh;
	text = "Del.ang.gd. 8 (gd. 40, 56, 104, 120)";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	...
	h = h + dh;
	text = "Del.ang.gd. 12 (gd. 36, 60, 100, 124)";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	...
	h = h + dh;
	text = "Del.ang.gd. 16 (gd. 0, 32,  64,  96)";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	text = roundNumber(DelAngGirdle_16/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);	
	
	h = h + dh;
	text = "Del.ang.gd. 20 (gd. 4, 28,  68,  92)";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	text = roundNumber(DelAngGirdle_20/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);	
	
	h = h + dh;
	text = "Del.ang.gd. 24 (gd. 8, 24,  72,  88)";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	text = roundNumber(DelAngGirdle_24/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);	
	
	h = h + dh;
	text = "Del.ang.gd. 28 (gd. 12, 20,  76,  84)";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	text = roundNumber(DelAngGirdle_28/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);	
