...
function pars_value()
{
	...
	h = h + dh;
	text = "Delta girdle thickness ";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);
	text = roundNumber(del_gd*100, 3) + "%";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);
	...
	h = h + dh;
	var text = "Crown angle girdle ";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);		
	text = roundNumber(crown_ang_gd/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);
	
	h = h + dh;
	var text = "Pavilion angle girdle ";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);		
	text = roundNumber(pav_ang_gd/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);
	
	h = h + dh;
	var text = "Corner angle girdle ";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);		
	text = roundNumber(ang_corner/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);
	...
	h = h + dh;
	var text = "Star facets ";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);		
	text = roundNumber(starFacets, 2);
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);	
	...
	h = h + dh;
	text = "Pavilion angle (pavilionAngle) ";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	text = roundNumber(pavilionAngle/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);
	
	h = h + dh;
	var text = "Offset virtual culet X ";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);		
	text = roundNumber(virtCuletOffsetX/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);	
	
	h = h + dh;
	var text = "Offset virtual culet Y ";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);		
	text = roundNumber(virtCuletOffsetY/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);	

	h = h + dh;
	var text = "pavilionFirstLevel ";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);		
	text = roundNumber(pavilionFirstLevel, 2);
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);	

	h = h + dh;
	var text = "pavilionLastLevel ";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);		
	text = roundNumber(pavilionLastLevel, 2);
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);

	h = h + dh;
	var text = "kf_bulge_s2 ";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);		
	text = roundNumber(kf_bulge_s2, 2);
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);

	h = h + dh;
	var text = "kf_bulge_s3 ";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);		
	text = roundNumber(kf_bulge_s3, 2);
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);
...
function print_text_index(index) // 100, 130, 160
{
	...
	if (index == 98)
	{
		ctx.fillText("Pavilion facet a4", left_2, h1);
	}
	if (index == 97)
	{
		ctx.fillText("Pavilion facet a3", left_2, h1);
	}	
	if (index == 140)
	{
