...
{	
	...
	document.getElementById("btn_crown1").checked = true;
	document.getElementById("btn_crown1").addEventListener("change", radio_crown1);
	document.getElementById("btn_crown2").addEventListener("change", radio_crown2);
...
function pars_value()
{
	...
	h = h + dh;
	text = "Delta Angle Crown ";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	text = roundNumber(DeltaAngleCrown/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);	
	...
	h = h + dh;
	text = "Pavilion angle (angle_pav) ";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	text = roundNumber(angle_pav/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);
