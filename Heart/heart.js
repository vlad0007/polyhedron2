...
function pars_value()
{
	...
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);		
	text = roundNumber(lambda/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);			
	...
	h = h + dh;
	text = "Crown angle (crown_angle) ";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	text = roundNumber(crown_angle/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);	
	...
	h = h + dh;
	text = "Pavilion angle (pav_angle) ";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	text = roundNumber(pav_angle/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);		
	...
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	text = roundNumber(DelAngGirdle_6/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);	
	...
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	text = roundNumber(DelAngGirdle_18/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);
	...
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	text = roundNumber(DelAngGirdle_26/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);	
	...
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	text = roundNumber(DelAngGirdle_34/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);	
	...
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	text = roundNumber(DelAngGirdle_38/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);	
	...
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	text = roundNumber(DelAngGirdle_42/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);	
	...
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	text = roundNumber(DelAngGirdle_46/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);	
}	
...
function print_text_index(index) // 100, 130, 160
{
	...
	if (index == 9)
	{
		ctx.fillText("Crown facet S", left_2, h1);
	}
	if (index == 10)
	{
...
function create_num_vertices(enumeration)
{
	...
	for (i = 0; i < n; i++) 
	{
		...
		if  ( (i > 15)&&(i < 21) || (i > 21)&&(i < 27)  || (i > 27)&&(i < 33)    || (i > 33)&&(i < 41)   || (i > 41)&&(i < 49) ||
			  ...
			  (i > 69)&&(i < 73) || (i > 73)&&(i < 77) || (i > 77)&&(i < 81) || (i > 81)&&(i < 89) || (i > 97)&&(i < 103) ||
			  (i > 103)&&(i < 109) || (i > 109)&&(i < 115) || (i > 115)&&(i < 127) || (i > 127)&&(i < 133) || (i > 133)&&(i < 141) ||
			  (i > 141)&&(i < 149) || (i > 149)&&(i < 153) || (i > 153)&&(i < 157) || (i > 157)&&(i < 161) || (i > 161)&&(i < 165) ||
			  (i > 116)&&(i < 120) || (i > 120)&&(i < 124) || (i > 124)&&(i < 128) || (i > 128)&&(i < 132) || (i > 132)&&(i < 136) ||
			  (i > 165)&&(i < 169) || (i > 169)&&(i < 173)  || (i > 173)&&(i < 177)  || (i > 177)&&(i < 181)  || (i > 181)&&(i < 189)
			   || (i > 189)&&(i < 197)  || (i > 197)&&(i < 203)  || (i > 203)&&(i < 215)   || (i > 223)&&(i < 227) || (i > 227)&&(i < 230) )
		{
		...
		if (enumeration == 2)
		{
			...
			else if ( (number > 15) && (number < 215) )
			{
				...
				generateGeometry( meshText, (number + 1 - 16).toString() );	
			}
			else 
			{
				meshText.add(
...
function radio_crown1() // корона1
{ 
	if (document.getElementById("btn_crown1").checked == true )
	{
		document.getElementById("btn_crown2").checked = false;
		build_crown_1 = true;
		recalc();
	}
}

function radio_crown2() // корона2
{ 
	if (document.getElementById("btn_crown2").checked == true )
	{
		document.getElementById("btn_crown1").checked = false;
		build_crown_1 = false;
		recalc();
	}
}
