...
function pars_value()
{
	...
	h = h + dh;
	var text = "Front angle girdle (ang_2) ";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);		
	...
	h = h + dh;
	var text = "Flank angle girdle (ang_3) ";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);		
	text = roundNumber(ang_3/DEGREE, 3) + "°";
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);
...
*/	
	...
	h = h + dh;
	text = "Pavilion angle facet b (pav_ang_c) ";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	...
	h = h + dh;
	text = "Pavilion angle facet c (pav_ang_b) ";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);	
	...
	h = h + dh;
	var text = "Delta level 1 - level 2 (del_hp1) ";
	ctx.fillStyle = text_color;
	ctx.fillText(text, w1, h);		
	text = roundNumber(del_hp1, 2);
	ctx.fillStyle = value_color;
	ctx.fillText(text, w2, h);
